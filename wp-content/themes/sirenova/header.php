            ...
            <div class="find__block" id="findForm">
                <div class="wrapper">
                    ...
                    <form role="search" method="get" class="find__form" action="https://sirenova.com.ua/">
                        <input type="search" class="find__form-inp" placeholder="Введіть не меньше 3 символів" value="" name="s" title="Search for:">
                    ...
                    <div class="result-form">
                        <a class="result-find" href="#">
                            <div class="result-find__img">
                                <img width="300" height="300" src="http://localhost:8000/wp-content/uploads/2024/08/swimsuit_fused_smooth_black_and_red_bodysuit_1-300x300.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" decoding="async" fetchpriority="high" srcset="http://localhost:8000/wp-content/uploads/2024/08/swimsuit_fused_smooth_black_and_red_bodysuit_1-300x300.jpg 300w, http://localhost:8000/wp-content/uploads/2024/08/swimsuit_fused_smooth_black_and_red_bodysuit_1-150x150.jpg 150w, http://localhost:8000/wp-content/uploads/2024/08/swimsuit_fused_smooth_black_and_red_bodysuit_1-100x100.jpg 100w" sizes="(max-width: 300px) 100vw, 300px">
                            </div>
                            <div class="result-find-all">
                                <p><span>Купальник</span> злитий гладкий чорно-червоний боді</p>
                        ...
                        <a href='#' class="form-show-all">Переглянути всі</a>
                    </div>
                </div>
